...
## ThreeJS
　JavaScript3Dライブラリ。今回使ったのは、ThreeJSおよびreact-native用のReactレンダラーの**"react-three-fiber"** です。
...
以下の&lt;Canvas&gt;コンポーネントやuseFrameカスタムフックを用いることで大体のやりたい事ができると考えている。
...
回答を求めるアルゴリズムについては、線形代数の初歩的な素養を要求するので、今回は割愛する。
`
        }
    },
    computed: {
